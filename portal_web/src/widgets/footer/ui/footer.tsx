...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1e3a8a] text-white pt-10 pb-6 border-t border-blue-800 mt-auto">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-8 text-sm items-start">
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-blue-200 uppercase text-xs tracking-wider">Навигация</h4>
          ...
          {/* 2. Студентам */}
          <div className="space-y-4">
            <h4 className="font-bold text-blue-200 uppercase text-xs tracking-wider">Студентам</h4>
            <ul className="space-y-2">
          ...
          {/* 3. Партнерам */}
          <div className="space-y-4">
            <h4 className="font-bold text-blue-200 uppercase text-xs tracking-wider">Партнерам</h4>
            <ul className="space-y-2">
          ...
          {/* 4. Сотрудникам */}
          <div className="space-y-4">
            <h4 className="font-bold text-blue-200 uppercase text-xs tracking-wider">Сотрудникам</h4>
            <ul className="space-y-2">
          ...
          <div className="space-y-4 col-span-2 md:col-span-1 lg:col-span-1">
             <h4 className="font-bold text-blue-200 uppercase text-xs tracking-wider">Контакты</h4>
            <ul className="space-y-3 text-blue-100/80">
              ...
              <li className="flex items-center gap-2">
                <span>✉️</span>
                <a href="mailto:info@sibadi.org" className="hover:text-white underline decoration-blue-400/50">info@sibadi.org</a>
              </li>
            </ul>
          </div>
        ...
        {/* Разделитель */}
        <div className="border-t border-blue-800/50 my-6"></div>
...
const FooterLink = ({ href, children }: { href: string, children: React.ReactNode }) => (
  <Link href={href} className="text-blue-100/70 hover:text-white transition-colors hover:translate-x-1 inline-block duration-200">
    {children}
  </Link>
);