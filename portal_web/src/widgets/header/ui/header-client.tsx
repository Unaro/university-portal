    ...
    <header className="sticky top-0 z-50 w-full border-b bg-primary text-primary-foreground shadow-md">
      <div className="container mx-auto flex h-20 items-center justify-between px-4">
        ...
        <Link href="/" className="flex items-center gap-4 group">
           <div className="bg-primary-foreground p-2 rounded-full transition-transform group-hover:scale-105 shrink-0 shadow-md">
              <div className="h-8 w-8 flex items-center justify-center font-bold text-primary">С</div>
           </div>
           <div className="flex flex-col leading-none">
              <span className="font-bold text-2xl tracking-wide group-hover:text-primary-foreground/80 transition-colors">СИБАДИ</span>
              <span className="text-[11px] text-primary-foreground/70 uppercase tracking-[0.25em] mt-1">Портал трудоустройства</span>
           </div>
        </Link>

        <nav className="hidden lg:flex items-center gap-3 bg-primary-foreground/10 rounded-full px-3 py-2 backdrop-blur-sm mx-4">
          ...
          {isLoggedIn ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-12 w-12 rounded-full border-2 border-primary-foreground/20 hover:bg-primary-foreground/20 p-0 overflow-hidden">
            ...
            <>
              <Link href="/login">
                 <Button variant="ghost" className="text-primary-foreground hover:bg-primary-foreground/20 hover:text-primary-foreground font-semibold text-base px-6 h-12">
                   <LogIn className="mr-2 h-5 w-5" /> Войти
                 </Button>
              </Link>
              <Link href="/register">
                <Button className="bg-primary-foreground text-primary hover:bg-accent font-bold text-base px-8 h-12 shadow-lg hover:shadow-xl transition-all rounded-full">
  ...
  return (
    <Link
      ...
      className={`
        ...
        ${isActive
          ? "bg-primary-foreground text-primary shadow-md transform scale-105"
