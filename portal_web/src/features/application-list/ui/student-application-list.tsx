  ...
  return (
    <div className="space-y-4">
      {applications.map((app) => (
        <div key={app.id} className="flex flex-col md:flex-row md:items-center justify-between p-4 border rounded-lg hover:shadow-sm transition-shadow gap-4 bg-card">
          <div>
            <h4 className="font-bold text-lg text-foreground">{app.vacancyTitle}</h4>
          ...
          <div className="flex items-center gap-4">
             {app.status === "approved" && <Badge className="bg-green-600 hover:bg-green-700 dark:hover:bg-green-500">Приглашение</Badge>}
